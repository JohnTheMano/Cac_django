...
def vehiculos_anio(request, anio):
    ...
    vehiculos = [
        {'nombre': 'Renault Sandero Stepway', 'anio': 2020},
        {'nombre': 'Peugeot 208', 'anio': 2021},
        {'nombre': 'Volkswagen Tuareg', 'anio': 2021},
        {'nombre': 'Mitsubishi Colt', 'anio': 2023},
        {'nombre': 'Ford ka', 'anio': 2023}]
